...
CREATE TABLE `device`  (
  ...
  `laboratory_id` int NULL DEFAULT NULL COMMENT '所属实验室',
  `price` float NULL DEFAULT NULL COMMENT '价格',
  `maker` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '制造厂商',
...
-- Records of device
-- ----------------------------
INSERT INTO `device` VALUES (1000, 'http://127.0.0.1:8080/image/1689080137281image.jpg', '200kV透射电子显微镜', 'REPAIRING', 1000, NULL, NULL);
INSERT INTO `device` VALUES (1001, 'http://127.0.0.1:8080/image/1689080197346image.jpg', '120kV透射电子显微镜', 'AVAILABLE', 1000, NULL, NULL);
INSERT INTO `device` VALUES (1002, 'http://127.0.0.1:8080/image/1689080229915image.jpg', '场发射透射电子显微镜', 'BORROWED', 1001, NULL, NULL);
INSERT INTO `device` VALUES (1003, 'http://127.0.0.1:8080/image/1689080243906image.jpg', '场发射扫描电子显微镜', 'BORROWED', 1000, NULL, NULL);
INSERT INTO `device` VALUES (1004, 'http://127.0.0.1:8080/image/1689080252396image.jpg', '场发射扫描电子显微镜', 'BORROWED', 1000, NULL, NULL);
INSERT INTO `device` VALUES (1005, 'http://127.0.0.1:8080/image/1689080263809image.jpg', '场发射扫描电子显微镜', 'AVAILABLE', 1001, NULL, NULL);
INSERT INTO `device` VALUES (1006, 'http://127.0.0.1:8080/image/1689080982196image.jpg', '400MHz核磁共振波谱仪', 'BORROWED', 1002, NULL, NULL);
INSERT INTO `device` VALUES (1007, 'http://127.0.0.1:8080/image/1689080396306image.jpg', '等离子体发射光谱仪', 'REPAIRING', 1003, NULL, NULL);
INSERT INTO `device` VALUES (1008, 'http://127.0.0.1:8080/image/1689081029452image.jpg', 'X射线多晶衍射仪', 'AVAILABLE', 1004, NULL, NULL);
INSERT INTO `device` VALUES (1009, 'http://127.0.0.1:8080/image/1689080458044image.jpg', '傅立叶变换红外光谱仪', 'REPAIRING', 1003, NULL, NULL);
INSERT INTO `device` VALUES (1010, 'http://127.0.0.1:8080/image/1689080548689image.jpg', '共聚焦显微拉曼光谱仪', 'DAMAGED', 1003, NULL, NULL);
INSERT INTO `device` VALUES (1011, 'http://127.0.0.1:8080/image/1689081049284image.jpg', '600MHz傅里叶变换核磁共振谱仪', 'BORROWED', 1002, NULL, NULL);
INSERT INTO `device` VALUES (1012, 'http://127.0.0.1:8080/image/1689080606749image.jpg', '大体积热解吸/气相色谱仪', 'BORROWED', 1005, NULL, NULL);
INSERT INTO `device` VALUES (1013, 'http://127.0.0.1:8080/image/1689080636006image.jpg', '气质联用仪', 'BORROWED', 1005, NULL, NULL);
INSERT INTO `device` VALUES (1014, 'http://127.0.0.1:8080/image/1689080657928image.jpg', '气体专用检测气相色谱仪', 'BORROWED', 1005, NULL, NULL);
INSERT INTO `device` VALUES (1015, 'http://127.0.0.1:8080/image/1689080694040image.jpg', '气相色谱仪', 'AVAILABLE', 1005, NULL, NULL);
INSERT INTO `device` VALUES (1016, 'http://127.0.0.1:8080/image/1689080700914image.jpg', '热脱附气相色谱仪', 'AVAILABLE', 1005, NULL, NULL);
INSERT INTO `device` VALUES (1017, 'http://127.0.0.1:8080/image/1689080707426image.jpg', '气相色谱仪', 'BORROWED', 1005, NULL, NULL);
INSERT INTO `device` VALUES (1018, 'http://127.0.0.1:8080/image/1689080713810image.jpg', '顶空气相色谱仪', 'REPAIRING', 1005, NULL, NULL);
INSERT INTO `device` VALUES (1019, 'http://127.0.0.1:8080/image/1689080719951image.jpg', '液相色谱仪', 'DAMAGED', 1005, NULL, NULL);
INSERT INTO `device` VALUES (1020, 'http://127.0.0.1:8080/image/1689080765231image.jpg', '液相色谱仪', 'AVAILABLE', 1005, NULL, NULL);
INSERT INTO `device` VALUES (1021, 'http://127.0.0.1:8080/image/1689080736798image.jpg', '高压液相色谱仪', 'AVAILABLE', 1005, NULL, NULL);
INSERT INTO `device` VALUES (1022, 'http://127.0.0.1:8080/image/1689080743376image.jpg', '高效液相色谱仪', 'AVAILABLE', 1005, NULL, NULL);
INSERT INTO `device` VALUES (1023, 'http://127.0.0.1:8080/image/1689080781354image.jpg', '液相色谱仪', 'AVAILABLE', 1005, NULL, NULL);
INSERT INTO `device` VALUES (1024, 'http://127.0.0.1:8080/image/1689080801639image.jpg', '冷冻超薄切片机', 'AVAILABLE', 1000, NULL, NULL);
INSERT INTO `device` VALUES (1025, 'http://127.0.0.1:8080/image/1689080827195image.jpg', '定点修块抛光机', 'AVAILABLE', 1000, NULL, NULL);
INSERT INTO `device` VALUES (1026, 'http://127.0.0.1:8080/image/1689080846997image.jpg', '离子减薄仪', 'AVAILABLE', 1000, NULL, NULL);
INSERT INTO `device` VALUES (1027, 'http://127.0.0.1:8080/image/1689080865816image.jpg', '三重四极杆气相色谱-质谱联用仪', 'AVAILABLE', 1005, NULL, NULL);
INSERT INTO `device` VALUES (1028, 'http://127.0.0.1:8080/image/1689081075839image.jpg', '综合物性测量系统', 'AVAILABLE', 1006, NULL, NULL);
INSERT INTO `device` VALUES (1029, 'http://127.0.0.1:8080/image/1689080885624image.jpg', 'X射线光电子能谱仪', 'AVAILABLE', 1003, NULL, NULL);
...
CREATE TABLE `device_appendix`  (
  `device_appendix_id` int NOT NULL AUTO_INCREMENT COMMENT '附件ID',
  `name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '附件名',
  `device_id` int NULL DEFAULT NULL COMMENT '关联的设备ID',
...
CREATE TABLE `device_apply`  (
  `device_apply_id` int NOT NULL AUTO_INCREMENT COMMENT '申请ID',
  ...
  `device_id` int NULL DEFAULT NULL COMMENT '申请的设备',
  `user_id` int NULL DEFAULT NULL COMMENT '申请人',
  `cost` float NULL DEFAULT NULL COMMENT '维修价格',
  `plant` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '维修厂商',
...
-- ----------------------------
INSERT INTO `device_apply` VALUES (2, '比较感兴趣，希望借来研究一下', '1689955200000', '1688746103088', NULL, NULL, NULL, 'DENIED', 1002, 4, 33, 'www');
INSERT INTO `device_apply` VALUES (3, '1', '1690473600000', '1688575673855', '1688735203698', NULL, NULL, 'GRANTED', 1004, 5, 333, 'qqq');
INSERT INTO `device_apply` VALUES (4, '11', '1689868800000', '1688735270197', NULL, NULL, NULL, 'APPLIED', 1003, 5, NULL, NULL);
INSERT INTO `device_apply` VALUES (5, 'wwwwww', '1689955200000', '1688746103088', NULL, NULL, NULL, 'APPLIED', 1006, 5, NULL, NULL);
INSERT INTO `device_apply` VALUES (6, '1111', '1689868800000', '1688746415748', NULL, NULL, NULL, 'APPLIED', 1010, 1, NULL, NULL);
INSERT INTO `device_apply` VALUES (7, '5555', '1692892800000', '1688746438012', NULL, NULL, NULL, 'APPLIED', 1012, 5, NULL, NULL);
INSERT INTO `device_apply` VALUES (8, 'wwwwww', '1689955200000', '1688746485867', NULL, NULL, NULL, 'APPLIED', 1009, 1, 11.2, 'ddddd');
INSERT INTO `device_apply` VALUES (9, '123', '1689264000000', '1688800064020', NULL, NULL, NULL, 'APPLIED', 1017, 5, NULL, NULL);
INSERT INTO `device_apply` VALUES (10, '本人对这方面很感兴趣，望通过批准', '1689696000000', '1689082571496', NULL, NULL, NULL, 'APPLIED', 1002, 5, NULL, '');
...
CREATE TABLE `device_comment`  (
  `device_comment_id` int NOT NULL AUTO_INCREMENT COMMENT '设备评论ID',
  ...
  `device_id` int NULL DEFAULT NULL COMMENT '评论的设备',
  `user_id` int NULL DEFAULT NULL COMMENT '评论者',
...
-- ----------------------------
INSERT INTO `device_comment` VALUES (1, '设备近期维修，请三天后再申请', '1689264000000', 1000, 2);
INSERT INTO `device_comment` VALUES (2, '我想预约使用该设备', '1689264000000', 1000, 4);
...
CREATE TABLE `device_property`  (
  `device_property_id` int NOT NULL AUTO_INCREMENT COMMENT '属性ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1080 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `device_record`  (
  `device_record_id` int NOT NULL AUTO_INCREMENT COMMENT '设备使用记录ID',
  ...
  `user_id` int NULL DEFAULT NULL COMMENT '使用者',
  `device_id` int NULL DEFAULT NULL COMMENT '关联的设备',
...
-- ----------------------------
INSERT INTO `device_record` VALUES (1, '1689264000000', 'http://127.0.0.1:8080/image/image12.jpg', '设备使用中，状态正常', 4, 1000);
...
CREATE TABLE `device_repair`  (
  `device_apply_id` int NOT NULL AUTO_INCREMENT COMMENT '申请ID',
  `borrow_reason` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '申请理由',
  `repair_timestamp` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '使用者报修时间',
  `grant_timestamp` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '管理员授权维修时间',
  `repair_plant` varchar(56) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '维修厂家',
  `repair_cost` float NULL DEFAULT NULL COMMENT '维修费用',
  `finish_timestamp` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '管理员归档时间',
  `status` enum('APPLIED','REPAIR','RETURNED','FINISHED','DENIED','CANCELED','DAMAGE') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '申请状态',
  `device_id` int NULL DEFAULT NULL COMMENT '申请的设备',
  `user_id` int NULL DEFAULT NULL COMMENT '申请人',
  PRIMARY KEY (`device_apply_id`) USING BTREE
...
CREATE TABLE `laboratory`  (
  `laboratory_id` int NOT NULL AUTO_INCREMENT COMMENT '实验室ID',
...
INSERT INTO `laboratory` VALUES (1004, '分析测试中心X衍射室', '大学城校区理5栋108', 'xrdlab@scnu.edu.cn', 3);
INSERT INTO `laboratory` VALUES (1005, '分析测试中心色谱质谱室', '大学城校区理2栋224', '147981385@qq.com', 2);
INSERT INTO `laboratory` VALUES (1006, '先进光电子研究院', '大学城校区理5栋526室', 'zhangah1110@163.com', 3);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'root', 'dd@163.com', 'e10adc3949ba59abbe56e057f20f883e', 'http://127.0.0.1:8080/image/default.jpg', 'SUPER_ADMIN', 'ENABLE');
INSERT INTO `user` VALUES (2, '李老师', '1172510964@qq.com', 'e10adc3949ba59abbe56e057f20f883e', 'http://127.0.0.1:8080/image/1689068304276image.jpg', 'ADMIN', 'ENABLE');
INSERT INTO `user` VALUES (3, '张三', '3@qq.com', 'e10adc3949ba59abbe56e057f20f883e', 'http://127.0.0.1:8080/image/1689081137884image.jpg', 'ADMIN', 'ENABLE');
...
INSERT INTO `user` VALUES (5, 'dy', 'iedingyi@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'http://127.0.0.1:8080/image/1689082454009image.jpg', 'NORMAL', 'ENABLE');
